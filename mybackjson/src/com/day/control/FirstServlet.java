...
public class FirstServlet extends HttpServlet {
	...
	public FirstServlet() {
		super();
		System.out.println("FirstSevlet객체 생성됨");
//        //context-param값을 얻기
...
//        System.out.println("책임개발자 : " + devName);
	...
	public void init(ServletConfig config) throws ServletException {
		System.out.println("FirstSevlet의 init() 호출됨");
		...
		System.out.println("FirstServlet에서만 사용할 수 있는 파라미터 fileName:" + fileName);

	}

	public void destroy() {
		System.out.println("FirstSevlet의 destroy() 호출됨");
	}

	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("FirstSevlet의 doGet() 호출됨");
		...
		System.out.println("servletPath:" + servletPath); //	/first
...
String attrValue = (String)obj;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("FirstSevlet의 doPost() 호출됨");
	}
